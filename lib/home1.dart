          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.separated(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Chaise1Page(imagepath: _tablehorizontal[index]),
                          ),
                        );
                      },
                      child: Card(
                ...
                itemCount: _tablehorizontal.length,
              ),
            ),
            SizedBox(
              height: 20,
            ...
            SizedBox(
              ...
              child: ListView.separated(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Chaise1Page(imagepath: _tablevertical[index]),
                          ),
                        );
                      },
                      child: Card(
                ...
                itemCount: _tablevertical.length,
              ),
            ),
          ],
        ),
